...
import { getBookingSetupData, saveBookingOption } from "@/lib/server/booking-setup";
...
export async function GET() {
  ...
  return NextResponse.json({ optionGroups: data.optionGroups });
}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("Could not create booking option", error);
